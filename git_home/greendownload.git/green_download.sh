...
#	echo 3 > /proc/sys/vm/drop_caches
	...
	greendownload -w $work_dir -s $statfifo_work_dir -u $green_dl_uprate -d $green_dl_downrate -r $green_dl_max_tasks_run -a $green_dl_max_tasks_all -i $wan_if_name
}

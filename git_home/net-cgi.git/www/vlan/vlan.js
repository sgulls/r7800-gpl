function check_vlan_input(cf,flag)
{
	...
	if(!(flag=='edit' && default_internet ==1))
	{
		...
		if(wired==0 && wireless==0 && (parent.support_orange_flag !=1 && cf.vlan_name.value != "OrangeIPTV"))
		{
			alert("$vlan_error5");
			return false;
		}
		if(wired==0 && wireless==0 && (parent.support_orange_flag ==1 && cf.vlan_name.value == "SpainIPTV"))
		{
			alert("$vlan_error5");
			change_type(cf);
			return false;

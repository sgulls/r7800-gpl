...
function basic_menu_class_default()
{
	...
	*/
	...
	if((top.enable_ap_flag== 1 || top.enable_bridge_flag== 1) && top.vpn_client_flag == "1"){
		var wds_div = top.document.getElementById("vpn_client");
		wds_div.className = wds_div.className + "_grey";
	}
...
function click_action(id)
{
		...
		else if( id == "funjsq" && top.enable_ap_flag != 1 && top.enable_bridge_flag == 0 && top.enable_extender_flag == "0" )
		{
			...
			if(funjsq_no_need_login != "1")
                ...
                else if( id == "vpn_client" && top.vpn_client_flag == "1" && top.enable_ap_flag != 1 && top.enable_bridge_flag == 0)
		{

...
var ap_items = [ "internet", "wan", "block_site", "block_services", "forwarding_triggering","qos","vpn", "remote", "upnp", "traffic", "wl_bridge", "lan", "ipv6", "parental", "usb_set", "devname", "vpn_client"];
...
var bridge_items = ["internet", "wan", "block_site", "block_services", "forwarding_triggering","qos","vpn", "dns", "static", "remote", "upnp", "traffic", "wireless", "guest", "lan", "parental","access_control",  "email", "schedule", "wds", "ipv6", "wlap","vpn_client"];
...
function click_adv_action(id)
{
	if(id == "adv_setup_wizard")
		...
		{
			if(top.vpn_client_enhance=="1")
				goto_formframe("vpn_client_enhance.htm");
			else
